...
{
    AZ_TYPE_INFO_WITH_NAME_IMPL(JHO3DETestGemModuleInterface, "JHO3DETestGemModuleInterface", JHO3DETestGemModuleInterfaceTypeId);
    ...
    JHO3DETestGemModuleInterface::JHO3DETestGemModuleInterface()
    {
        ...
        m_descriptors.insert(m_descriptors.end(), { JHO3DETestGemSystemComponent::CreateDescriptor() });
    }
